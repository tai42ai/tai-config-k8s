"""tai-config-k8s — the Kubernetes ``ConfigManager`` provider plugin.

Ships :class:`K8sConfigManager`, an implementation of the
:class:`tai_contract.config.manager.ConfigManager` ABC that reads/writes
...
from tai_config_k8s.manager import (
    K8sConfigError,
    K8sConfigManager,
